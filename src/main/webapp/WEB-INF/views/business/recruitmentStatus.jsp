...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/recruitmentStatus.css">
<script src="${pageContext.request.contextPath}/js/recruitmentStatus.js"
	defer></script>
</head>
...
<body>
	...
	<div id="Recruitment_Status">
		...
		<div id="Recruitment_StatusView">
			...
			<div>
				<a href="#" class="status-link active">진행중 20</a> <a href="#"
					class="status-link">&emsp;대기중 15</a> <a href="#"
					class="status-link">&emsp;임시저장 7</a> <a href="#"
					class="status-link">&emsp;마감 15</a>
			</div>
		...
		<div id="Registration_containers">
			...
			<div class="Registration_First_Container">
				...
				<a href="#"
					style="font-size: 1.5rem; font-weight: 600; margin-top: 21px;">제목이
					입력되지 않았습니다.</a>

				<div id="Recruitment_Status_Calender" style="margin-top: 10px">
					<img
						src="${pageContext.request.contextPath}/img/calendar-blank.png">
					<b>게시기간 입력 되지 않음</b>
				</div>
			</div>
