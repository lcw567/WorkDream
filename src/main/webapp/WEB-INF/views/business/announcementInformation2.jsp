...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/announcementInformation2.css">
<script>
	const contextPath = "${pageContext.request.contextPath}";
</script>
<script
	src="${pageContext.request.contextPath}/js/announcementInformation2.js"
	defer></script>
</head>
...
<body>
	<div id="Job_Announcement_Information">
		...
		<div id="Job_Announcement_Information_content">
			...
			<p
				style="color: #000000; font-weight: 900; margin-top: 2px; margin-bottom: 40px;">*
				최소 1200 x 800px 이상, 3:2 비율의 이미지</p>

			<div class="Contact_Announcement_Information_Title">
				<h2>공고 소개</h2>
			</div>
			<textarea class="Text_Container"
				placeholder="회사나 제품 / 서비스 또는 공고에 대한 소개를 작성해주세요."></textarea>

			<div class="Contact_Announcement_Information_Title">
				<h2>주요 업무</h2>
			</div>
			<textarea class="Text_Container"
				placeholder="해당 포지션에서 어떤 업무를 하는지 작성해주세요."></textarea>

			<div class="Contact_Announcement_Information_Title">
				<h2>자격 요건</h2>
			</div>
			<textarea class="Text_Container"
				placeholder="업무상 꼭 필요한 필수 요건을 작성해 주세요."></textarea>
			...
			<textarea class="Text_Container"
				placeholder="서류 전형, 면접 등 채용 절차를 작성해 주세요."></textarea>
