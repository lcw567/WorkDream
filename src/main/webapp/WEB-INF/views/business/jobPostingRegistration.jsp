...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/jobPostingRegistration.css">
        ...
        <div id="Job_Posting_Registration_content">
            ...
            <div class="Contact_Information">
                ...
                <div class="Contact_Information" style="margin-bottom: 80px;">
                    ...
                    <div id="Company_logo">
                        <img src="${pageContext.request.contextPath}/img/icons8-이미지-편집-48.png">
                    </div>
