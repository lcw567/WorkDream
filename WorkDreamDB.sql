...
DROP TABLE RESUME_PORTFOLIO CONSTRAINTS;
...
COMMENT ON COLUMN JOB_RECRUITMENT.STATUS IS '공고 현황(임시저장:T / 진행중: P / 종료: E)';
...
-- RESUME_PORTFOLIO 중간 테이블 생성
CREATE TABLE RESUME_PORTFOLIO (
    RESUME_NO NUMBER NOT NULL,
    PORTFOLIO_ID NUMBER NOT NULL,
    PRIMARY KEY (RESUME_NO, PORTFOLIO_ID),
    CONSTRAINT FK_RESUME_PORTFOLIO_RESUME FOREIGN KEY (RESUME_NO)
        REFERENCES RESUME (RESUME_NO)
        ON DELETE CASCADE,
    CONSTRAINT FK_RESUME_PORTFOLIO_PORTFOLIO FOREIGN KEY (PORTFOLIO_ID)
