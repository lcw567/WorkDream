...
COMMENT ON COLUMN MEMBER.BUSINESS_NO IS '기업 번호';
COMMENT ON COLUMN MEMBER.PERSON_NO IS '개인 번호';
...
COMMENT ON COLUMN BUSINESS.BUSINESS_NO IS '기업 번호';
COMMENT ON COLUMN BUSINESS.REGISTRATION_NUMBER IS '사업자 등록번호';
COMMENT ON COLUMN BUSINESS.OWNER_NAME IS '대표 이름';
COMMENT ON COLUMN BUSINESS.COMPANY_NAME IS '회사 이름';
COMMENT ON COLUMN BUSINESS.COMPANY_CODE IS '회사 코드';
COMMENT ON COLUMN BUSINESS.COMPANY_TEL IS '회사 전화번호';
COMMENT ON COLUMN BUSINESS.COMPANY_ADDR IS '회사 주소';
COMMENT ON COLUMN BUSINESS.COMPANY_FAX IS '팩스 번호';
COMMENT ON COLUMN BUSINESS.COMPANY_SITE IS '홈페이지 URL';
COMMENT ON COLUMN BUSINESS.LOGO IS '회사 로고';
COMMENT ON COLUMN BUSINESS.INTRODUCTION IS '회사 소개';
COMMENT ON COLUMN BUSINESS.VISION IS '회사 비전';
COMMENT ON COLUMN BUSINESS.COMPANY_TYPE IS '회사 유형';
COMMENT ON COLUMN BUSINESS.EMPLOYEE_COUNT IS '직원 수';
COMMENT ON COLUMN BUSINESS.INDUSTRY IS '업종';
COMMENT ON COLUMN BUSINESS.BRAND_NAME IS '브랜드 이름';
...
COMMENT ON COLUMN PERSON.PERSON_NO IS '개인 번호';
COMMENT ON COLUMN PERSON.NAME IS '개인 이름';
COMMENT ON COLUMN PERSON.BIRTHDAY IS '생일';
COMMENT ON COLUMN PERSON.GENDER IS '성별';
COMMENT ON COLUMN PERSON.PHONE IS '전화번호';
...
/* PERSON 테이블에 기본 키 추가 (이미 존재한다고 가정) */
ALTER TABLE PERSON
