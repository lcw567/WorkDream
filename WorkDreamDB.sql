...
CONSTRAINT fk_certificates_resume FOREIGN KEY (resume_no)
        REFERENCES resume(resume_no)
        ON DELETE CASCADE;

CONSTRAINT fk_language_tests_resume FOREIGN KEY (resume_no)
        REFERENCES resume(resume_no)
        ON DELETE CASCADE;

CONSTRAINT fk_awards_resume FOREIGN KEY (resume_no)
        REFERENCES resume(resume_no)
        ON DELETE CASCAD;
