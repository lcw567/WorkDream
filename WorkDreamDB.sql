...
CREATE TABLE ACADEMIC_ABILITY(
    ACDEMIC_NO NUMBER NOT NULL PRIMARY KEY,
    RESUME_NO NUMBER NOT NULL,
    PERSON_NO NUMBER NOT NULL,
    EDUCATION_LEVEL VARCHAR2(20) NOT NULL,
    ACDEMIC_NAME VARCHAR2(100) NOT NULL,
...
-- 컬럼 주석 추가
COMMENT ON COLUMN ACADEMIC_ABILITY.ACADEMIC_NO IS '학력번호';
COMMENT ON COLUMN ACADEMIC_ABILITY.RESUME_NO IS '이력서번호';
COMMENT ON COLUMN ACADEMIC_ABILITY.PERSON_NO IS '개인번호';
COMMENT ON COLUMN ACADEMIC_ABILITY.EDUCATION_LEVEL IS '학력 수준';
COMMENT ON COLUMN ACADEMIC_ABILITY.ACDEMIC_NAME IS '교육기관명';
COMMENT ON COLUMN ACADEMIC_ABILITY.MAJOR IS '전공';
COMMENT ON COLUMN ACADEMIC_ABILITY.DEGREE IS '학제';
COMMENT ON COLUMN ACADEMIC_ABILITY.GRADUATION_STATUS IS '졸업 여부';
COMMENT ON COLUMN ACADEMIC_ABILITY.ENTER_DATE IS '입학일자';
COMMENT ON COLUMN ACADEMIC_ABILITY.GRADUATION_DATE IS '졸업(수료)일자';
COMMENT ON COLUMN ACADEMIC_ABILITY.LOCATION IS '지역';
COMMENT ON COLUMN ACADEMIC_ABILITY.EXAM_PASSED IS '검정고시 합격 여부';


/* QUALIFICATION 테이블 생성 */
CREATE TABLE QUALIFICATION (
    QUALIFICATION_NO NUMBER PRIMARY KEY,
    RESUME_NO NUMBER NOT NULL,
    CATEGORY VARCHAR2(20) NOT NULL,          -- 구분 (certificate, language, award)
    NAME VARCHAR2(100) NOT NULL,             -- 자격증명, 어학시험명, 수상명
    ISSUING_AGENCY VARCHAR2(100),            -- 발행처/기관 (언어 및 자격증에 적용)
    PROFICIENCY_LEVEL NUMBER,                -- 급수 (어학시험에만 적용)
    LANGUAGE_TYPE VARCHAR2(20),              -- 언어 종류 (어학시험에만 적용)
    PASS_STATUS VARCHAR2(20),                -- 합격 구분 (자격증에만 적용)
    ISSUE_DATE DATE,                         -- 발급일자 또는 수상일자
    FOREIGN KEY (RESUME_NO) REFERENCES RESUME(RESUME_NO)
);

COMMENT ON COLUMN QUALIFICATION.QUALIFICATION_NO IS '자격/어학/수상 고유번호';
COMMENT ON COLUMN QUALIFICATION.RESUME_NO IS '이력서 번호';
COMMENT ON COLUMN QUALIFICATION.CATEGORY IS '구분 (certificate, language, award)';
COMMENT ON COLUMN QUALIFICATION.NAME IS '자격증/어학시험/수상명';
COMMENT ON COLUMN QUALIFICATION.ISSUING_AGENCY IS '발행처/기관';
COMMENT ON COLUMN QUALIFICATION.PROFICIENCY_LEVEL IS '급수 (어학시험에만 적용)';
COMMENT ON COLUMN QUALIFICATION.LANGUAGE_TYPE IS '언어 종류 (어학시험에만 적용)';
COMMENT ON COLUMN QUALIFICATION.PASS_STATUS IS '합격 구분 (자격증에만 적용)';
COMMENT ON COLUMN QUALIFICATION.ISSUE_DATE IS '발급일자 또는 수상일자';
...
COMMENT ON COLUMN EXPERIENCE.RESUME_NO IS '이력서번호';
COMMENT ON COLUMN EXPERIENCE.PERSON_NO IS '개인번호';
COMMENT ON COLUMN EXPERIENCE.ACTIVITY_TYPE IS '활동구분';
COMMENT ON COLUMN EXPERIENCE.ORGANIZATION_NAME IS '기관/장소명';
COMMENT ON COLUMN EXPERIENCE.START_DATE IS '시작년월';
COMMENT ON COLUMN EXPERIENCE.END_DATE IS '종료년월';
...
COMMENT ON COLUMN SKILL.PERSON_NO IS '개인번호';
COMMENT ON COLUMN SKILL.SKILL_NAME IS '스킬명';
...
CREATE TABLE CAREER (
    ...
    JOB_CONTENT VARCHAR2(500) NOT NULL, -- 데이터 타입 확대
...
COMMENT ON COLUMN CAREER.PERSON_NO IS '개인번호';
...
COMMENT ON COLUMN CAREER.START_DATE IS '입사년월';
COMMENT ON COLUMN CAREER.END_DATE IS '퇴사년월';
