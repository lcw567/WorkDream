...
COMMENT ON COLUMN ACADEMIC_ABILITY.ACADEMIC_NAME IS '교육기관명';
COMMENT ON COLUMN ACADEMIC_ABILITY.ACADEMIC_TYPE IS '교육기관유형';
COMMENT ON COLUMN ACADEMIC_ABILITY.DEGREE IS '학위여부';
