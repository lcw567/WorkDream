...
INSERT INTO JOB_POSITION (POSITION_NO, RECRUITMENT_NO, POSITION_NAME, POSITION_RANK, EMPLOYMENT_FORM, RECRUITED_PEOPLE)
VALUES (NULL, SEQ_JOB.CURRVAL, '경영자문부문 QRM', '컨설턴트', 'R', 0);
...
INSERT INTO JOB_STAGY (
    ...
    NULL, SEQ_JOB.CURRVAL, 1, '인성 검사',
    TO_TIMESTAMP(TO_CHAR(SYSDATE - 10, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    TO_TIMESTAMP(TO_CHAR(SYSDATE + 4, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    'P'
);
...
INSERT INTO JOB_RECRUITMENT (
    ...
    TO_TIMESTAMP(TO_CHAR(SYSDATE - 10, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    TO_TIMESTAMP(TO_CHAR(SYSDATE + 1, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    SYSDATE,
    '/img/posting4.PNG', 
...
INSERT INTO JOB_POSITION (POSITION_NO, RECRUITMENT_NO, POSITION_NAME, POSITION_RANK, EMPLOYMENT_FORM, RECRUITED_PEOPLE)
VALUES (NULL, SEQ_JOB.CURRVAL, '회계사', '대리', 'R', 1);
...
INSERT INTO JOB_STAGY (
    ...
    NULL, SEQ_JOB.CURRVAL, 1, '서류 전형',
    TO_TIMESTAMP(TO_CHAR(SYSDATE - 10, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    TO_TIMESTAMP(TO_CHAR(SYSDATE + 2, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    'P'
);
...
INSERT INTO JOB_RECRUITMENT (
    ...
    TO_TIMESTAMP(TO_CHAR(SYSDATE - 10, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    TO_TIMESTAMP(TO_CHAR(SYSDATE + 7, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    SYSDATE,
    '/img/posting5.PNG',
    '우대사항' || CHR(10) ||
    '제조 데이터 분석 경험' || CHR(10) ||
...
INSERT INTO JOB_RECRUITMENT (
    ...
    TO_TIMESTAMP(TO_CHAR(SYSDATE - 60, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
...
INSERT INTO JOB_POSITION (POSITION_NO, RECRUITMENT_NO, POSITION_NAME, POSITION_RANK, EMPLOYMENT_FORM, RECRUITED_PEOPLE)
VALUES (NULL, SEQ_JOB.CURRVAL, '경영관리자', '협의', 'R', 0);
...
INSERT INTO JOB_STAGY (
    ...
    NULL, SEQ_JOB.CURRVAL, 1, '서류 전형',
    TO_TIMESTAMP(TO_CHAR(SYSDATE - 50, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    TO_TIMESTAMP(TO_CHAR(SYSDATE - 35, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    'E'
);
...
INSERT INTO JOB_STAGY (
    ...
    NULL, SEQ_JOB.CURRVAL, 1, '1차면접(실무)',
    TO_TIMESTAMP(TO_CHAR(SYSDATE - 35, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
...
INSERT INTO JOB_STAGY (
    ...
    NULL, SEQ_JOB.CURRVAL, 1, '최종면접(임원)',
    TO_TIMESTAMP(TO_CHAR(SYSDATE - 20, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    TO_TIMESTAMP(TO_CHAR(SYSDATE - 10, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    'E'
);
...
INSERT INTO JOB_RECRUITMENT (
    ...
    TO_TIMESTAMP(TO_CHAR(SYSDATE - 20, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    TO_TIMESTAMP(TO_CHAR(SYSDATE + 3, 'YYYY-MM-DD HH24:MI:SS'), 'YYYY-MM-DD HH24:MI:SS'),
    SYSDATE,
    '/img/posting1.PNG7', 
...
INSERT INTO JOB_POSITION (POSITION_NO, RECRUITMENT_NO, POSITION_NAME, POSITION_RANK, EMPLOYMENT_FORM, RECRUITED_PEOPLE)
VALUES (NULL, SEQ_JOB.CURRVAL, '대외공무', '일반사원', 'R', 0);

INSERT INTO JOB_POSITION (POSITION_NO, RECRUITMENT_NO, POSITION_NAME, POSITION_RANK, EMPLOYMENT_FORM, RECRUITED_PEOPLE)
VALUES (NULL, SEQ_JOB.CURRVAL, '품질관리', '일반사원', 'R', 0);

INSERT INTO JOB_POSITION (POSITION_NO, RECRUITMENT_NO, POSITION_NAME, POSITION_RANK, EMPLOYMENT_FORM, RECRUITED_PEOPLE)
VALUES (NULL, SEQ_JOB.CURRVAL, '대외공무(해외)', '일반사원', 'R', 0);
